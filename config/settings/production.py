...
#     os.path.join(ROOT_DIR, "gcs.json")
# )
...
# STATIC
# ------------------------
STATICFILES_STORAGE = "api_project.utils.storages.StaticRootGoogleCloudStorage"
...
# MEDIA
# ------------------------------------------------------------------------------
DEFAULT_FILE_STORAGE = "api_project.utils.storages.MediaRootGoogleCloudStorage"
