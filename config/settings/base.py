...
REST_FRAMEWORK = {
    "DEFAULT_PAGINATION_CLASS": "api_project.common.pagination.DefaultPagination",
    "PAGE_SIZE": 20,
    ...
    "DEFAULT_FILTER_BACKENDS": [
        ...
        "api_project.common.utils.CustomOrderingFilter",
    ],
}
...
CORS_ORIGIN_ALLOW_ALL = env.bool("CORS_ALLOW_ORIGIN", default=False)
